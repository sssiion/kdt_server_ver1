...
public class ChatController {
    ...
    public void  sendMessage(@Payload ChatMessageDto dto) throws JsonProcessingException {
        ...
        rabbitTemplate.convertAndSend(RabbitMQConfig.CHAT_EXCHANGE, "chat.room."+dto.getRoomId(),json); //exchate명, routing key, 실제 데이터
    }
    @MessageMapping(".chat.addUser")
    public void addUser(@Payload ChatMessageDto dto, SimpMessageHeaderAccessor headers) throws JsonProcessingException {
        //세션에 사용자 정보 저장
