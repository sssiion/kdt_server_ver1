...
public interface LoanDocsRepository extends JpaRepository<LoanDocs, Long> {
    ...
    List<LoanDocs> findByApplicationId(Long applicationId);
    // 대출 신청 ID로 서류 조회
    ...
    List<LoanDocs> findByApplicationIdOrderByUploadDateDesc(Long applicationId);
    ...
    List<LoanDocs> findByApplicationIdAndFileType(@Param("applicationId") Long applicationId, @Param("fileType") String fileType);
